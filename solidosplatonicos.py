...
class solidosplatonicos(inkex.Effect):
    ...
    def effect(self):
        ...
        #If anidado para ver que figura hay que dibujar
        if figura == "Hexaedro" :
            if isCalado and distanciaCalado >= longitud/2 :
                errorArg('La distancia de calado no puede ser mayor que el apotema del cuadrado')
            ...
            if isCalado and apotema < distanciaCalado :
        ...
        #Creamos un grupo nuevo en caso de que se quieran agrupas las figuras
        if grupo :
